...
SOLIDNES_GPU_BLOCKED_PARTITIONS_DEFAULT="gpu80gllm,gpu40gllm,h20llm,h20,gpu4090,gpu4090_8,gpu4090_128,h800,test"
if [ "$SOLIDNES_GPU_ALLOW_TEST" = "1" ] || [ "$SOLIDNES_GPU_ALLOW_TEST" = "true" ]; then
  SOLIDNES_GPU_BLOCKED_PARTITIONS_DEFAULT="gpu80gllm,gpu40gllm,h20llm,h20,gpu4090,gpu4090_8,gpu4090_128,h800"
fi
